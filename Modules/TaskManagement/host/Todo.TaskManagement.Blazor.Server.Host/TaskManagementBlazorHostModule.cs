...
using Todo.TaskManagement.Blazor.Server.Host.Menus;
...
namespace Todo.TaskManagement.Blazor.Server.Host
{
    [DependsOn(
        ...
        typeof(TaskManagementBlazorServerModule)
    )]
    public class TaskManagementBlazorHostModule: AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
            {
                options.AddAssemblyResource(
                    ...
                    typeof(TaskManagementBlazorHostModule).Assembly
                );
            });
        }
        ...
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            Configure<AbpBundlingOptions>(options =>
            {
                ...
                options.StyleBundles.Configure(
                    ...
                    bundle =>
                    {
                        ...
                        bundle.AddFiles("/Todo.TaskManagement.Blazor.Server.Host.styles.css");
                    }
                );
            });
            ...
            context.Services.AddAuthentication()
                .AddJwtBearer(options =>
                {
                    ...
                    options.Audience = "TaskManagement";
                });
            ...
            if(hostingEnvironment.IsDevelopment())
            {
                Configure<AbpVirtualFileSystemOptions>(options =>
                {
                    ...
                    options.FileSets.ReplaceEmbeddedByPhysical<TaskManagementBlazorHostModule>(hostingEnvironment.ContentRootPath);
                });
            }
            ...
            {
                options.AppAssembly = typeof(TaskManagementBlazorHostModule).Assembly;
            });
        }
